...
class Game {
  ...
  launchMissle(e) {
    ...
    this.missile = new __WEBPACK_IMPORTED_MODULE_3__missile__["a" /* default */](null, angle, this.onDeckBall.color);
  ...
  start() {
    ...
    this.canvas.addEventListener('click', e => this.launchMissle(e));
...
class Chain {
  constructor() {
    this.head = new __WEBPACK_IMPORTED_MODULE_0__ball__["a" /* default */]('HEAD');
    this.tail = new __WEBPACK_IMPORTED_MODULE_0__ball__["a" /* default */]('TAIL');
...
/* unused harmony default export */ var _unused_webpack_default_export = (Chain);
